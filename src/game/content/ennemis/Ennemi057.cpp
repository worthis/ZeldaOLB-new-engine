...
void Ennemi057::addEnnemi(int i)
{
    ...
    if (!tryToAddEnnemi(dstX, dstY, i) && !tryToAddEnnemi(dstX - 8, dstY, i) && !tryToAddEnnemi(dstX + 8, dstY, i) && !tryToAddEnnemi(dstX, dstY - 8, i) && !tryToAddEnnemi(dstX - 8, dstY - 8, i) && !tryToAddEnnemi(dstX + 8, dstY - 8, i) && !tryToAddEnnemi(dstX, dstY + 8, i) && !tryToAddEnnemi(dstX - 8, dstY + 8, i) && !tryToAddEnnemi(dstX + 8, dstY + 8, i) && !tryToAddEnnemi(dstX - 16, dstY, i) && !tryToAddEnnemi(dstX + 16, dstY, i) && !tryToAddEnnemi(dstX, dstY - 16, i) && !tryToAddEnnemi(dstX - 16, dstY - 16, i) && !tryToAddEnnemi(dstX + 16, dstY - 16, i) && !tryToAddEnnemi(dstX, dstY + 16, i) && !tryToAddEnnemi(dstX - 16, dstY + 16, i) && !tryToAddEnnemi(dstX + 16, dstY + 16, i) && !tryToAddEnnemi(dstX - 32, dstY, i) && !tryToAddEnnemi(dstX + 32, dstY, i) && !tryToAddEnnemi(dstX, dstY - 32, i) && !tryToAddEnnemi(dstX - 32, dstY - 32, i) && !tryToAddEnnemi(dstX + 32, dstY - 32, i) && !tryToAddEnnemi(dstX, dstY + 32, i) && !tryToAddEnnemi(dstX - 32, dstY + 32, i) && !tryToAddEnnemi(dstX + 32, dstY + 32, i))
    {
        anim = 0;
        cooldown = 8;
    }

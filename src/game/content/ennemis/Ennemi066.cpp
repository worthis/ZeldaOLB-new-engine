...
Ennemi066::Ennemi066(int i, int j, Map *map) : anim(0), animMax(3), vanim(180), animTentacules(0)
{
    ...
    if (map != 0)
    {
        tentaculeHG = new Ennemi068(x - 16 * 2 + 12 - 8, y + 16 * 6 - 4);
        tentaculeBG = new Ennemi068(x - 16 * 2 + 4 - 8, y + 16 * 7 + 12);
        tentaculeHD = new Ennemi069(x + 16 * 5 + 10 - 57 + 8, y + 16 * 6 - 4);
        tentaculeBD = new Ennemi069(x + 16 * 5 + 18 - 57 + 8, y + 16 * 7 + 12);

        tentaculeTopG1 = new Ennemi068(x - 16 * 2 + 12 - 16, y + 8);
        tentaculeTopG2 = new Ennemi068(x - 16 * 3 + 12 - 16 - 8, y + 8 + 32);
        tentaculeTopD1 = new Ennemi069(x + 16 * 5 + 10 - 57 + 16, y + 8);
        tentaculeTopD2 = new Ennemi069(x + 16 * 6 + 10 - 57 + 16 + 8, y + 8 + 32);
        ...
        map->addEnnemi(tentaculeTopG1);
        map->addEnnemi(tentaculeTopG2);
        map->addEnnemi(tentaculeTopD1);
        map->addEnnemi(tentaculeTopD2);
    }
...
void Ennemi066::giveItem(int x, int y)
{
    ...
    tentaculeTopG1->endOfLife();
    tentaculeTopG2->endOfLife();
    tentaculeTopD1->endOfLife();
    tentaculeTopD2->endOfLife();
    map->addItem(ItemHelper::getInstance()->createItem(TI_COEUR, x + 1, y + 7 * 16 + 4, 6));
}
...
void Ennemi066::wakeUp()
{
    ...
    for (int i = 0; i < 4; i++)
    {
        if (steps[i] == 1)
        {
            ...
            {
            case 0:
                tentaculeHG->setStep(1);
                break;
            case 1:
                tentaculeBG->setStep(1);
                break;
            case 2:
                tentaculeHD->setStep(1);
                break;
            case 3:
                tentaculeBD->setStep(1);
                break;
            }
        }
    }
...
void Ennemi066::setSteps(int value)
{
    for (int i = 0; i < 4; i++)
    {
        if (steps[i] > 0)
        {
            ...
            {
            case 0:
                tentaculeHG->setStep(value);
                break;
            case 1:
                tentaculeBG->setStep(value);
                break;
            case 2:
                tentaculeHD->setStep(value);
                break;
            case 3:
                tentaculeBD->setStep(value);
                break;
            }
        }
    }

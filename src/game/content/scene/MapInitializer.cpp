...
void MapInitializer::init() {
    ...
    if (!link->getStatus()->isOniLinkable()) {
        if (zone==12 || zone==5 || zone==6 || zone==4 || zone==10 || zone==2 || zone==9) {
            if (!scene->getMonsters(19)) monstre1 = 1 + (rand()%14);
            if (!scene->getMonsters(24)) monstre2 = 1 + (rand()%14);
            if (monstre2 == monstre1) monstre2 = 0;
            if (!scene->getMonsters(35)) monstre3 = 1 + (rand()%14);
    ...
    switch (map->getId()) {
        ...
        case 2 :
            ...
            if (monstre1 == zone) addEnnemi(new Ennemi019(50*16, 49*16));
            if (monstre2 == zone) addEnnemi(new Ennemi024(50*16, 49*16, false));
            if (monstre3 == zone) addEnnemi(new Ennemi035(50*16, 49*16));
        ...
        case 4 :
            ...
            if (monstre1 == zone) addEnnemi(new Ennemi019(24*16, 32*16));
            if (monstre2 == zone) addEnnemi(new Ennemi024(24*16, 32*16, false));
            if (monstre3 == zone) addEnnemi(new Ennemi035(24*16, 32*16));
        ...
        case 5 :
            ...
            if (monstre1 == zone) addEnnemi(new Ennemi019(157*16, 32*16));
            if (monstre2 == zone) addEnnemi(new Ennemi024(157*16, 32*16, false));
            if (monstre3 == zone) addEnnemi(new Ennemi035(157*16, 32*16));
        ...
        case 6 :
            ...
            if (monstre1 == zone) addEnnemi(new Ennemi019(46*16, 49*16));
            if (monstre2 == zone) addEnnemi(new Ennemi024(46*16, 49*16, false));
            if (monstre3 == zone) addEnnemi(new Ennemi035(46*16, 49*16));
        ...
        addObject(new Pierre(16*43, 16*104, 1, map));
            ...
            if (scene->getAvancement() == AV_ARMEE_UP) {
                ...
                if (monstre1 == zone) addEnnemi(new Ennemi019(50*16, 92*16));
                if (monstre2 == zone) addEnnemi(new Ennemi024(50*16, 92*16, false));
                if (monstre3 == zone) addEnnemi(new Ennemi035(50*16, 92*16));
            }
        ...
        case 10 :
            ...
            if (monstre1 == zone) addEnnemi(new Ennemi019(60*16, 24*16));
            if (monstre2 == zone) addEnnemi(new Ennemi024(60*16, 24*16, false));
            if (monstre3 == zone) addEnnemi(new Ennemi035(60*16, 24*16));
        ...
        case 12 :
            ...
            if (monstre1 == zone) addEnnemi(new Ennemi019(55*16, 43*16));
            if (monstre2 == zone) addEnnemi(new Ennemi024(55*16, 43*16, false));
            if (monstre3 == zone) addEnnemi(new Ennemi035(55*16, 43*16));
            break;
        case 13 :
        ...
        case 15 :
            ...
            if (scene->getCoffre(1, 2) == 2) ouvrePorte(89, 28, 0);
            ...
            if (scene->getCoffre(1, 8)) ouvrePorte(18, 21, 1);
            if (scene->getCoffre(1, 9)) ouvrePorte(38, 51, 1);
            if (scene->getCoffre(1, 10)) ouvrePorte(109, 43, 0);
            if (scene->getCoffre(1, 11)) ouvrePorte(178, 21, 1);
            if (scene->getCoffre(1, 12)) ouvrePorte(9, 43, 0);
            if (scene->getCoffre(1, 13)) ouvrePorte(29, 13, 0);
            if (scene->getCoffre(1, 14)) ouvrePorte(49, 43, 0);
        ...
        case 16 :
            ...
            if (!scene->getCoffre(2, 5)) addObject(new Pnj(16*174, 16*17+8, 40, 324));
            if (!scene->getCoffre(2, 6)) addObject(new Pnj(16*185, 16*17+8, 41, 324));
            if (!scene->getCoffre(2, 7)) addObject(new Pnj(16*194, 16*62+8, 42, 324));
            ...
            if (scene->getCoffre(2, 2) == 2) ouvrePorte(249, 88, 0);

            if (scene->getCoffre(2, 9)) ouvrePorte(109, 28, 0);
            if (scene->getCoffre(2, 10)) ouvrePorte(118, 66, 1);
            if (scene->getCoffre(2, 11)) ouvrePorte(124, 73, 0);
            if (scene->getCoffre(2, 12)) ouvrePorte(134, 73, 0);
            if (scene->getCoffre(2, 13)) ouvrePorte(249, 13, 0);
            if (scene->getCoffre(2, 14)) ouvrePorte(9, 13, 0);
            if (scene->getCoffre(2, 15)) ouvrePorte(58, 51, 1);
            if (scene->getCoffre(2, 16)) ouvrePorte(89, 13, 0);
            if (scene->getCoffre(2, 17)) ouvrePorte(174, 22, 2);
            if (scene->getCoffre(2, 18)) ouvrePorte(185, 22, 2);
            if (scene->getCoffre(2, 19)) ouvrePorte(178, 66, 1);
            if (scene->getCoffre(2, 20)) ouvrePorte(194, 66, 2);
            if (scene->getCoffre(2, 21)) ouvrePorte(204, 13, 0);
            if (scene->getCoffre(2, 22)) ouvrePorte(238, 2, 1);
            if (scene->getCoffre(2, 23)) ouvrePorte(229, 43, 0);
            if (scene->getCoffre(2, 24)) ouvrePorte(238, 10, 1);
            if (scene->getCoffre(2, 25)) ouvrePorte(238, 92, 1);
            if (scene->getCoffre(2, 26)) ouvrePorte(269, 43, 0);
            if (scene->getCoffre(2, 27)) ouvrePorte(278, 6, 1);
            if (scene->getCoffre(2, 28)) ouvrePorte(289, 28, 0);
            if (scene->getCoffre(2, 29)) ouvrePorte(278, 36, 1);
            if (scene->getCoffre(2, 30)) ouvrePorte(158, 81, 1);
            if (scene->getCoffre(2, 31)) ouvrePorte(258, 66, 1);
            if (scene->getCoffre(2, 32)) ouvrePorte(269, 73, 0);
        ...
        case 17 :
            ...
            if (scene->getCoffre(3, 8)) ouvrePorte(69, 13, 0);
            if (scene->getCoffre(3, 9)) ouvrePorte(69, 43, 0);
            if (scene->getCoffre(3, 10)) ouvrePorte(69, 73, 0);
            if (scene->getCoffre(3, 11)) ouvrePorte(189, 28, 0);
            if (scene->getCoffre(3, 12)) ouvrePorte(154, 73, 0);
            if (scene->getCoffre(3, 13)) ouvrePorte(178, 21, 1);
            if (scene->getCoffre(3, 14)) ouvrePorte(198, 81, 1);
            if (scene->getCoffre(3, 15)) ouvrePorte(209, 73, 0);
            if (scene->getCoffre(3, 16)) ouvrePorte(198, 111, 1);
            if (scene->getCoffre(3, 17)) ouvrePorte(49, 43, 2);
            if (scene->getCoffre(3, 18)) ouvrePorte(78, 51, 3);
            if (scene->getCoffre(3, 19)) ouvrePorte(89, 73, 2);
            if (scene->getCoffre(3, 20)) ouvrePorte(89, 66, 4);
            if (scene->getCoffre(3, 21)) ouvrePorte(158, 111, 3);
            if (scene->getCoffre(3, 22)) ouvrePorte(189, 43, 2);
            if (scene->getCoffre(3, 23)) ouvrePorte(229, 103, 2);
        ...
        case 18 :
            ...
            if (scene->getCoffre(4, 2) == 2) ouvrePorte(269, 28, 0);
            ...
            if (scene->getCoffre(4, 12)) ouvrePorte(98, 21, 1);
            if (scene->getCoffre(4, 13)) ouvrePorte(98, 51, 1);
            if (scene->getCoffre(4, 14)) ouvrePorte(138, 51, 1);
            if (scene->getCoffre(4, 15)) ouvrePorte(149, 28, 0);
            if (scene->getCoffre(4, 16)) ouvrePorte(278, 36, 1);
            if (scene->getCoffre(4, 17)) ouvrePorte(278, 66, 1);
            if (scene->getCoffre(4, 18)) ouvrePorte(289, 43, 0);
            if (scene->getCoffre(4, 19)) ouvrePorte(309, 43, 0);
            if (scene->getCoffre(4, 20)) ouvrePorte(149, 58, 0);
            if (scene->getCoffre(4, 21)) ouvrePorte(158, 21, 1);
            if (scene->getCoffre(4, 22)) ouvrePorte(169, 58, 0);
            if (scene->getCoffre(4, 23)) ouvrePorte(189, 58, 0);
            if (scene->getCoffre(4, 24)) ouvrePorte(198, 66, 1);
            if (scene->getCoffre(4, 25)) ouvrePorte(238, 36, 1);
            if (scene->getCoffre(4, 26)) ouvrePorte(238, 51, 1);
            if (scene->getCoffre(4, 27)) ouvrePorte(258, 51, 1);
            if (scene->getCoffre(4, 28)) ouvrePorte(270, 7, 5);
            if (scene->getCoffre(4, 29)) ouvrePorte(278, 51, 1);
            if (scene->getCoffre(4, 30)) ouvrePorte(289, 28, 0);
            if (scene->getCoffre(4, 31)) ouvrePorte(309, 58, 0);
            if (scene->getCoffre(4, 32)) ouvrePorte(69, 21, 4);
            if (scene->getCoffre(4, 33)) ouvrePorte(249, 43, 2);
            if (scene->getCoffre(4, 34)) ouvrePorte(289, 58, 2);
        ...
        case 19 :
            ...
            if (scene->getCoffre(5, 2) == 2) ouvrePorte(89, 43, 0);
            ...
            if (scene->getCoffre(5, 9)) ouvrePorte(49, 43, 0);
            if (scene->getCoffre(5, 10)) ouvrePorte(49, 58, 0);
            if (scene->getCoffre(5, 11)) ouvrePorte(149, 28, 0);
            if (scene->getCoffre(5, 12)) ouvrePorte(158, 6, 1);
            if (scene->getCoffre(5, 13)) ouvrePorte(158, 66, 1);
            if (scene->getCoffre(5, 14)) ouvrePorte(9, 43, 0);
            if (scene->getCoffre(5, 15)) ouvrePorte(78, 51, 1);
            if (scene->getCoffre(5, 16)) ouvrePorte(129, 58, 0);
            if (scene->getCoffre(5, 17)) ouvrePorte(129, 28, 0);
            if (scene->getCoffre(5, 18)) ouvrePorte(149, 13, 0);
            if (scene->getCoffre(5, 19)) ouvrePorte(138, 66, 1);
            if (scene->getCoffre(5, 20)) ouvrePorte(178, 36, 1);
            if (scene->getCoffre(5, 21)) ouvrePorte(158, 21, 3);
        ...
        case 20 :
            ...
            if (scene->getCoffre(6, 2) == 2) ouvrePorte(9, 43, 0);
            ...
            if (scene->getCoffre(6, 7)) ouvrePorte(98, 51, 1);
            if (scene->getCoffre(6, 8)) ouvrePorte(98, 66, 1);
            if (scene->getCoffre(6, 9)) ouvrePorte(78, 66, 1);
            if (scene->getCoffre(6, 11)) ouvrePorte(78, 51, 1);
            if (scene->getCoffre(6, 18)) ouvrePorte(84, 43, 0);
            if (scene->getCoffre(6, 19)) ouvrePorte(78, 40, 1);
            if (scene->getCoffre(6, 20)) ouvrePorte(78, 32, 1);
            if (scene->getCoffre(6, 21)) ouvrePorte(84, 28, 0);
            if (scene->getCoffre(6, 22)) ouvrePorte(78, 25, 1);
            if (scene->getCoffre(6, 23)) ouvrePorte(78, 17, 1);
            if (scene->getCoffre(6, 24)) ouvrePorte(84, 13, 0);
            if (scene->getCoffre(6, 25)) ouvrePorte(94, 13, 0);
            if (scene->getCoffre(6, 26)) ouvrePorte(98, 17, 1);
            if (scene->getCoffre(6, 27)) ouvrePorte(98, 25, 1);
            if (scene->getCoffre(6, 28)) ouvrePorte(94, 28, 0);
            if (scene->getCoffre(6, 29)) ouvrePorte(98, 32, 1);
            if (scene->getCoffre(6, 30)) ouvrePorte(98, 40, 1);
            if (scene->getCoffre(6, 31)) ouvrePorte(94, 43, 0);
            if (scene->getCoffre(6, 32)) ouvrePorte(58, 51, 1);
            if (scene->getCoffre(6, 33)) ouvrePorte(58, 66, 1);
            if (scene->getCoffre(6, 34)) ouvrePorte(118, 51, 1);
            if (scene->getCoffre(6, 35)) ouvrePorte(118, 66, 1);
        ...
        case 21 :
            ...
            if (scene->getCoffre(7, 2) == 2) ouvrePorte(249, 28, 0);
            ...
            if (scene->getCoffre(7, 11)) ouvrePorte(29, 43, 0);
            if (scene->getCoffre(7, 12)) ouvrePorte(49, 13, 0);
            if (scene->getCoffre(7, 13)) ouvrePorte(118, 21, 1);
            if (scene->getCoffre(7, 14)) ouvrePorte(158, 51, 1);
            if (scene->getCoffre(7, 15)) ouvrePorte(178, 51, 1);
            if (scene->getCoffre(7, 16)) ouvrePorte(209, 43, 0);
            if (scene->getCoffre(7, 17)) ouvrePorte(238, 36, 1);
            if (scene->getCoffre(7, 18)) ouvrePorte(29, 13, 0);
            if (scene->getCoffre(7, 19)) ouvrePorte(38, 51, 1);
            if (scene->getCoffre(7, 20)) ouvrePorte(38, 6, 1);
            if (scene->getCoffre(7, 21)) ouvrePorte(89, 28, 0);
            if (scene->getCoffre(7, 22)) ouvrePorte(118, 51, 1);
            if (scene->getCoffre(7, 23)) ouvrePorte(169, 13, 0);
            if (scene->getCoffre(7, 24)) ouvrePorte(189, 13, 0);
            if (scene->getCoffre(7, 25)) ouvrePorte(229, 28, 0);
            if (scene->getCoffre(7, 26)) ouvrePorte(229, 43, 0);
            if (scene->getCoffre(7, 27)) ouvrePorte(278, 21, 1);
        ...
        case 22 :
            ...
            if (scene->getCoffre(8, 2) == 2) ouvrePorte(89, 28, 0);
            ...
            if (scene->getCoffre(8, 10)) ouvrePorte(49, 28, 0);
            if (scene->getCoffre(8, 11)) ouvrePorte(58, 36, 1);
            if (scene->getCoffre(8, 12)) ouvrePorte(98, 81, 1);
            if (scene->getCoffre(8, 13)) ouvrePorte(118, 21, 1);
            if (scene->getCoffre(8, 14)) ouvrePorte(138, 81, 1);
            if (scene->getCoffre(8, 15)) ouvrePorte(149, 28, 0);
            if (scene->getCoffre(8, 16)) ouvrePorte(9, 73, 0);
            if (scene->getCoffre(8, 17)) ouvrePorte(38, 21, 1);
            if (scene->getCoffre(8, 18)) ouvrePorte(169, 28, 0);
            if (scene->getCoffre(8, 19)) ouvrePorte(189, 73, 0);
            if (scene->getCoffre(8, 20)) ouvrePorte(209, 43, 0);
            if (scene->getCoffre(8, 21)) ouvrePorte(9, 28, 2);
            if (scene->getCoffre(8, 22)) ouvrePorte(69, 28, 2);
            if (scene->getCoffre(8, 23)) ouvrePorte(98, 6, 3);
        ...
        case 23 :
            ...
            if (scene->getCoffre(9, 2) == 2) ouvrePorte(209, 43, 0);
            ...
            if (scene->getCoffre(9, 8)) ouvrePorte(49, 13, 0);
            if (scene->getCoffre(9, 9)) ouvrePorte(118, 66, 1);
            if (scene->getCoffre(9, 10)) ouvrePorte(138, 36, 1);
            if (scene->getCoffre(9, 11)) ouvrePorte(169, 43, 0);
            if (scene->getCoffre(9, 12)) ouvrePorte(89, 28, 0);
            if (scene->getCoffre(9, 13)) ouvrePorte(138, 51, 1);
            if (scene->getCoffre(9, 14)) ouvrePorte(178, 21, 1);
            if (scene->getCoffre(9, 15)) ouvrePorte(198, 6, 1);
            if (scene->getCoffre(9, 16)) ouvrePorte(218, 6, 1);
            if (scene->getCoffre(9, 17)) ouvrePorte(98, 36, 3);
            if (scene->getCoffre(9, 18)) ouvrePorte(118, 36, 3);
            if (scene->getCoffre(9, 19)) ouvrePorte(169, 7, 4);
            if (scene->getCoffre(9, 20)) ouvrePorte(238, 51, 3);
            if (scene->getCoffre(9, 21)) ouvrePorte(238, 66, 3);
        ...
        case 24 :
            ...
            if (scene->getCoffre(10, 2) == 2) ouvrePorte(49, 28, 0);
            ...
            if (scene->getCoffre(10, 9)) ouvrePorte(38, 36, 1);
            if (scene->getCoffre(10, 10)) ouvrePorte(38, 66, 1);
            if (scene->getCoffre(10, 11)) ouvrePorte(58, 51, 1);
            if (scene->getCoffre(10, 12)) ouvrePorte(138, 66, 1);
            if (scene->getCoffre(10, 13)) ouvrePorte(178, 21, 1);
            if (scene->getCoffre(10, 14)) ouvrePorte(58, 36, 1);
            if (scene->getCoffre(10, 15)) ouvrePorte(89, 58, 0);
            if (scene->getCoffre(10, 16)) ouvrePorte(109, 58, 0);
            if (scene->getCoffre(10, 17)) ouvrePorte(118, 51, 1);
            if (scene->getCoffre(10, 18)) ouvrePorte(149, 13, 0);
            if (scene->getCoffre(10, 19)) ouvrePorte(158, 66, 1);
            if (scene->getCoffre(10, 20)) ouvrePorte(178, 66, 1);
            if (scene->getCoffre(10, 21)) ouvrePorte(238, 6, 1);
            if (scene->getCoffre(10, 22)) ouvrePorte(49, 66, 4);
            if (scene->getCoffre(10, 23)) ouvrePorte(69, 6, 4);
            if (scene->getCoffre(10, 24)) ouvrePorte(178, 6, 3);
            if (scene->getCoffre(10, 25)) ouvrePorte(189, 13, 2);
            if (scene->getCoffre(10, 28)) ouvrePorte(129, 43, 0);
        ...
        case 25 :
            ...
            if (scene->getCoffre(11, 2) == 2) ouvrePorte(49, 88, 0);
            ...
            if (scene->getCoffre(11, 9)) ouvrePorte(9, 43, 0);
            if (scene->getCoffre(11, 10)) ouvrePorte(18, 96, 1);
            if (scene->getCoffre(11, 11)) ouvrePorte(29, 43, 0);
            if (scene->getCoffre(11, 12)) ouvrePorte(29, 88, 0);
            if (scene->getCoffre(11, 13)) ouvrePorte(89, 43, 0);
            if (scene->getCoffre(11, 14)) ouvrePorte(69, 28, 0);
            if (scene->getCoffre(11, 15)) ouvrePorte(69, 88, 0);
            if (scene->getCoffre(11, 16)) {
                ouvrePorte(58, 96, 1);
                ouvrePorte(69, 103, 0);
            }
            if (scene->getCoffre(11, 17)) ouvrePorte(89, 88, 0);
            if (scene->getCoffre(11, 18)) ouvrePorte(129, 73, 0);
            if (scene->getCoffre(11, 19)) ouvrePorte(38, 21, 3);
            if (scene->getCoffre(11, 20)) ouvrePorte(49, 28, 2);
            if (scene->getCoffre(11, 21)) ouvrePorte(109, 13, 2);
            if (scene->getCoffre(11, 22)) ouvrePorte(129, 28, 2);
            ...
            switch (scene->getCoffre(11, 23)) {
                case 0 : addEnnemi(new Ennemi072(56*16,36*16+6)); break;
                case 1 : addEnnemi(new Ennemi072(136*16,36*16+6)); break;
                case 2 : addEnnemi(new Ennemi072(39*16,104*16+6)); break;
                case 3 : addEnnemi(new Ennemi072(103*16,115*16+6)); break;
                case 4 : addEnnemi(new Ennemi072(194*16,111*16+6)); break;
                case 5 : ouvrePorte(198, 111, 1); break;
            }
        ...
        case 26 :
            ...
            if (scene->getCoffre(12, 2) == 2) ouvrePorte(309, 43, 0);
            ...
            if (scene->getCoffre(12, 9)) ouvrePorte(29, 43, 0);
            if (scene->getCoffre(12, 10)) ouvrePorte(58, 96, 1);
            if (scene->getCoffre(12, 11)) ouvrePorte(78, 96, 1);
            if (scene->getCoffre(12, 12)) ouvrePorte(109, 43, 0);
            if (scene->getCoffre(12, 13)) ouvrePorte(289, 28, 0);
            if (scene->getCoffre(12, 14)) ouvrePorte(9, 58, 0);
            if (scene->getCoffre(12, 15)) ouvrePorte(29, 58, 0);
            if (scene->getCoffre(12, 16)) ouvrePorte(49, 88, 0);
            if (scene->getCoffre(12, 17)) ouvrePorte(58, 21, 1);
            if (scene->getCoffre(12, 18)) ouvrePorte(69, 28, 0);
            if (scene->getCoffre(12, 19)) ouvrePorte(69, 13, 0);
            if (scene->getCoffre(12, 20)) ouvrePorte(78, 21, 1);
            if (scene->getCoffre(12, 21)) ouvrePorte(89, 58, 0);
            if (scene->getCoffre(12, 22)) ouvrePorte(89, 88, 0);
            if (scene->getCoffre(12, 23)) ouvrePorte(109, 58, 0);
            if (scene->getCoffre(12, 24)) ouvrePorte(118, 21, 1);
            if (scene->getCoffre(12, 25)) ouvrePorte(58, 66, 1);
            if (scene->getCoffre(12, 26)) ouvrePorte(78, 66, 3);
        ...
        case 27 :
            ...
            if (scene->getCoffre(13, 2) == 2) ouvrePorte(29, 58, 0);
            ...
            if (scene->getCoffre(13, 8)) ouvrePorte(38, 126, 1);
            if (scene->getCoffre(13, 9)) ouvrePorte(89, 103, 0);
            if (scene->getCoffre(13, 10)) ouvrePorte(109, 43, 0);
            if (scene->getCoffre(13, 11)) ouvrePorte(158, 66, 1);
            if (scene->getCoffre(13, 12)) ouvrePorte(29, 73, 0);
            if (scene->getCoffre(13, 13)) ouvrePorte(29, 118, 0);
            if (scene->getCoffre(13, 14)) ouvrePorte(38, 66, 1);
            if (scene->getCoffre(13, 15)) ouvrePorte(38, 111, 1);
            if (scene->getCoffre(13, 16)) ouvrePorte(109, 58, 2);
            if (scene->getCoffre(13, 17)) ouvrePorte(149, 58, 2);
            if (scene->getCoffre(13, 18)) ouvrePorte(149, 73, 2);
        ...
        case 28 :
            ...
            if (scene->getCoffre(14, 2) == 2) ouvrePorte(49, 133, 0);
            ...
            if (scene->getCoffre(14, 7)) ouvrePorte(49, 58, 0);
            if (scene->getCoffre(14, 8)) ouvrePorte(78, 96, 1);
            if (scene->getCoffre(14, 9)) ouvrePorte(138, 66, 1);
            if (scene->getCoffre(14, 10)) ouvrePorte(58, 66, 1);
            if (scene->getCoffre(14, 11)) ouvrePorte(58, 141, 1);
            if (scene->getCoffre(14, 12)) ouvrePorte(158, 51, 1);
            if (scene->getCoffre(14, 13)) ouvrePorte(49, 118, 0);
        ...
        case 44 :
            ...
            break;
        case 45 :
            if (scene->getCoffre(0, 13) == 2) { // getCoffre(0, 14) -> alreadyPaid for monsters
                ouvrePorte(29, 0, 0);
            }

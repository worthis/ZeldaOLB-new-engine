    ...
    if (map >= 15) { // indoor only
        ...
        switch (map) {
            ...
            case 21 :
                ...
                if (bounds.getX() >= 320 && bounds.getX() <= 320*3
                    && bounds.getY() >= 240*1 && bounds.getY() <= 240*2) {
                    bounds.setX(320);
                    bounds.setW(960);
                    break;
                }
            ...
            case 22 :
                ...
                if (bounds.getX() >= 320 && bounds.getX() <= 320*2
                    && bounds.getY() >= 240*2 && bounds.getY() <= 240*4) {
                    bounds.setX(320);
                    bounds.setY(240*2);
                    bounds.setW(640);
                    bounds.setH(720);
            ...
            case 23 :
                ...
                if (bounds.getX() >= 320*11 && bounds.getX() <= 320*12
                    && bounds.getY() >= 240 && bounds.getY() <= 240*2) {
                    bounds.setX(320*11);
                    bounds.setY(240);
                    bounds.setW(640);
...
void Map::reset() {
    ...
    testAnim(link->getX(), link->getY(), N, false); // BUG FIX: link bloqué si il revit sur une porte de maison
}
...
void Map::allumeTorche(int x, int y) { //1811 -> 1812
    Scene* scene = MainController::getInstance()->getGameController()->getSceneController()->getScene();
    switch (map) {
        case 18 :
            if (((x == 185 || x == 193) && y == 17)
                ...
                || (x == 212 && y == 23)
                || (x == 213 && y == 11)) {
                if (sol[185][17] == 1812 && sol[189][7] == 1812 && sol[193][17] == 1812
                    && sol[196][25] == 1812 && sol[200][16] == 1812 && sol[203][4] == 1812
                    && sol[208][16] == 1812 && sol[212][23] == 1812 && sol[213][11] == 1812
                    && mur[189 * 2 + 1][28 * 2 + 1] == MUR) {
        ...
        case 19 :
            ...
            if ((x == 165 || x == 174) && (y == 35 || y == 39 || y == 50 || y == 54)) {
                if (sol[165][35] == 1812 && sol[165][39] == 1812 && sol[165][50] == 1812 && sol[165][54] == 1812
                    && sol[174][35] == 1812 && sol[174][39] == 1812 && sol[174][50] == 1812 && sol[174][54] == 1812
                    && mur[178 * 2 + 1][52 * 2] == MUR) {
        ...
        case 22 :
            if ((x == 62 || x == 75) && (y == 49 || y == 55 || y == 64 || y == 70)) {
                if (sol[62][49] == 1812 && sol[62][55] == 1812 && sol[62][64] == 1812 && sol[62][70] == 1812
                    && sol[75][49] == 1812 && sol[75][55] == 1812 && sol[75][64] == 1812 && sol[75][70] == 1812
                    && mur[58 * 2 + 1][52 * 2] == MUR) {
...
void Map::eteintTorche(int x, int y) { //1812 -> 1811
}

void Map::activateInterStar(int x, int y, bool sound) {
    if (sound) AudioManager::getInstance()->playSound(TS_MAGIC);
    switch (map) {
        case 23 :
            if (y == 3*16) {
                holeStar(245, 4, 10, 4);
...
void Map::holeStar(int x, int y, int w, int h) {
    ...
    for (int j = y; j < y + h; j++) {
        for (int i = x; i < x + w; i++) {
            if (mur[i * 2][j * 2] == TROU) {
                if (mur[(i-1) * 2][(j-1) * 2] == TROU && mur[i * 2][(j-1) * 2] == TROU && mur[(i+1) * 2][(j-1) * 2] == TROU
                    && mur[(i-1) * 2][j * 2] == TROU && mur[(i+1) * 2][j * 2] == TROU
                    && mur[(i-1) * 2][(j+1) * 2] == TROU && mur[i * 2][(j+1) * 2] == TROU && mur[(i+1) * 2][(j+1) * 2] == TROU) {
                    ...
                    if (mur[(i+1) * 2][(j+1) * 2] != TROU) setSol(i * 16, j * 16, 3169 + offset);
                    if (mur[(i-1) * 2][(j+1) * 2] != TROU) setSol(i * 16, j * 16, 3170 + offset);
                    if (mur[(i+1) * 2][(j-1) * 2] != TROU) setSol(i * 16, j * 16, 3171 + offset);
                    if (mur[(i-1) * 2][(j-1) * 2] != TROU) setSol(i * 16, j * 16, 3172 + offset);
                }
            }
        }
    }
...
int Map::getMotif(int value) {
    ...
    switch (value) {
        ...
        case 415 : case 418 :
            ...
            break;
        case 353 : case 356 : case 1812 : case 2553 :
            switch (tmp % 4) {
                case 0 : return value;
                case 1 : return value + 1;
                case 2 : return value + 2;
        ...
        case 1463 : case 1471 : case 1473 : //clouds
            switch (tmp % 3) {
                case 0 : return value;
            ...
            break;
        case 1466 : case 1468 : case 1470 : //clouds
            switch (tmp % 3) {
                case 0 : return value;
                case 1 : return value + 24;
                case 2 : return value + 25;
            }
            break;
        case 1474 : case 1476 : //clouds
            switch (tmp % 3) {
                case 0 : return value;
                case 1 : return value + 26;
                case 2 : return value + 27;
            }
            break;
        case 1477 : //clouds
            switch (tmp % 3) {
        ...
        case 2360 : // pics
            ...
            break;
        case 2507 : case 2508 : case 2509 : case 2510 : case 2511 : case 2512 : case 2513 :
        case 2514 : case 2515 : case 2516 : case 2517 : case 2518 : case 2519 :
            switch ((tmp / 2) % 4) {
                case 0 : return value;
                case 1 : return value + 13;
                case 2 : return value + 26;
                case 3 : return value + 13;
            }
            break;
        case 2690 : case 2691 : case 2692 : case 2693 : case 2694 : case 2695 : case 2696 :
        case 2697 : case 2698 : case 2699 : case 2700 : case 2701 : case 2702 :
            switch (tmp / 2 % 3) {
                case 0 : return value;
                case 1 : return value + 13;
                case 2 : return value + 26;
            ...
            break;
        case 3548 : case 3549 : case 3550 : case 3551 : case 3552 : case 3553 :
        case 3554 : case 3555 : case 3556 : case 3557 : case 3558 : case 3559 :
            switch ((tmp / 2) % 4) {
                case 0 : return value;
                case 1 : return value + 12;
                case 2 : return value + 24;
                case 3 : return value + 12;
            }
            break;
        case 3584 : case 3588 : case 3592 : case 3596 :// tapis roulant
            switch (tmp % 4) {
                case 0 : return value;
                case 1 : return value + 1;
                case 2 : return value + 2;
        ...
        for (int i = beginX; i <= endX; i += CASE) {
            ...
            if (effect == TE_GLACE) {
                ...
                switch (val) {
                    ...
                    case 1812 : sol[x][y] = 1811; break; // torche
                    default : break;
                }
                if (val == 1812) eteintTorche(x, y);
            }
            if (type == TA_EXPLO) {
...
bool Map::testInnerTransition(int x, int y) {
    ...
    if (map == 26 && bounds.getX() >= 140*16 && bounds.getX() < 280*16) {
        bool fail = false;
        if (y <= bounds.getY()) {
            fail = bounds.getY()==0 || (bounds.getY()==15*16 && bounds.getX()==260*16)
                || (bounds.getY()==30*16 && (bounds.getX()==220*16 || bounds.getX()==240*16))
                || (bounds.getY()==45*16 && bounds.getX()<200*16) || (bounds.getY()==60*16 && bounds.getX()>200*16)
                || (bounds.getY()==75*16 && (bounds.getX()==160*16 || bounds.getX()==180*16 || bounds.getX()==240*16))
                || (bounds.getY()==90*16 && (bounds.getX()==140*16 || bounds.getX()==160*16 || bounds.getX()==220*16));
        } else if (y >= bounds.getY() + bounds.getH() - 32) {
            fail = bounds.getY()==90*16 || (bounds.getY()==0 && bounds.getX()==260*16)
                || (bounds.getY()==15*16 && (bounds.getX()==220*16 || bounds.getX()==240*16))
                || (bounds.getY()==30*16 && bounds.getX()<200*16) || (bounds.getY()==45*16 && bounds.getX()>200*16)
                || (bounds.getY()==60*16 && (bounds.getX()==160*16 || bounds.getX()==180*16 || bounds.getX()==240*16))
                || (bounds.getY()==75*16 && (bounds.getX()==140*16 || bounds.getX()==160*16 || bounds.getX()==220*16));
        } else if (x <= bounds.getX() + 8) {
            fail = bounds.getX()==140*16
                || (bounds.getX()==160*16 && (bounds.getY()==0 || bounds.getY()==30*16 || bounds.getY()==60*16))
                || (bounds.getX()==180*16 && (bounds.getY()==15*16 || bounds.getY()==45*16))
                || (bounds.getX()==200*16 && bounds.getY()!=0 && bounds.getY()!=45*16)
                || (bounds.getX()==220*16 && bounds.getY()!=45*16 && bounds.getY()!=90*16)
                || (bounds.getX()==240*16 && (bounds.getY()==15*16 || bounds.getY()==45*16))
                || (bounds.getX()==260*16 && (bounds.getY()==30*16 || bounds.getY()>60*16));
        } else if (x >= bounds.getX() + bounds.getW() - 24) {
            fail = bounds.getX()==260*16
                || (bounds.getX()==140*16 && (bounds.getY()==0 || bounds.getY()==30*16 || bounds.getY()==60*16))
                || (bounds.getX()==160*16 && (bounds.getY()==15*16 || bounds.getY()==45*16))
                || (bounds.getX()==180*16 && bounds.getY()!=0 && bounds.getY()!=45*16)
                || (bounds.getX()==200*16 && bounds.getY()!=45*16 && bounds.getY()!=90*16)
                || (bounds.getX()==220*16 && (bounds.getY()==15*16 || bounds.getY()==45*16))
                || (bounds.getX()==240*16 && (bounds.getY()==30*16 || bounds.getY()>60*16));
        }
        if (fail) {
...
void Map::testAnim(int x, int y, Direction dir, bool sound) {
    ...
    if (map == 9 && scene->getAvancement() == AV_ARMEE_UP && nbEnnemis() == 0) {
        ...
        if (sound) AudioManager::getInstance()->playMusic(music);
    }
    ...
    if (map >= 15 && map < 29) {
        ...
        if (scene->getCoffre(map - 14, 3)) {
            ...
            switch (map) {
                case 15 :
                    if (getSol(x, y + 7) == 1689 && dir == N) { i = x/16; j = ((y + 7)/16) - 3;}
                    if (getSol(x, y + 24) == 1693 && dir == S) { i = x/16; j = (y + 24)/16;}
                    if (getSol(x - 1, y + 16) == 1702 && dir == W) { i = ((x-1)/16) - 3; j = y/16;}
                    if (getSol(x + 16, y + 16) == 1708 && dir == E) { i = (x+16)/16; j = y/16;}
                    break;
                case 16 : case 20 :
                    if (getSol(x, y + 7) == 1894 && dir == N) { i = x/16; j = ((y + 7)/16) - 3;}
                    if (getSol(x, y + 24) == 1896 && dir == S) { i = x/16; j = (y + 24)/16;}
                    if (getSol(x - 1, y + 16) == 1903 && dir == W) { i = ((x-1)/16) - 3; j = y/16;}
                    if (getSol(x + 16, y + 16) == 1908 && dir == E) { i = (x+16)/16; j = y/16;}
                    break;
                case 17 :
                    if (getSol(x, y + 7) == 2054 && dir == N) { i = x/16; j = ((y + 7)/16) - 3;}
                    if (getSol(x, y + 24) == 2056 && dir == S) { i = x/16; j = (y + 24)/16;}
                    break;
                case 18 :
                    if (getSol(x, y + 7) == 2254 && dir == N) { i = x/16; j = ((y + 7)/16) - 3;}
                    if (getSol(x, y + 24) == 2256 && dir == S) { i = x/16; j = (y + 24)/16;}
                    if (getSol(x - 1, y + 16) == 2263 && dir == W) { i = ((x-1)/16) - 3; j = y/16;}
                    if (getSol(x + 16, y + 16) == 2268 && dir == E) { i = (x+16)/16; j = y/16;}
                    break;
                case 19 :
                    if (getSol(x, y + 7) == 2441 && dir == N) { i = x/16; j = ((y + 7)/16) - 3;}
                    if (getSol(x, y + 24) == 2443 && dir == S) { i = x/16; j = (y + 24)/16;}
                    if (getSol(x - 1, y + 16) == 2450 && dir == W) { i = ((x-1)/16) - 3; j = y/16;}
                    if (getSol(x + 16, y + 16) == 2455 && dir == E) { i = (x+16)/16; j = y/16;}
                    break;
                case 21 :
                    if (getSol(x, y + 7) == 2636 && dir == N) { i = x/16; j = ((y + 7)/16) - 3;}
                    if (getSol(x, y + 24) == 2640 && dir == S) { i = x/16; j = (y + 24)/16;}
                    if (getSol(x - 1, y + 16) == 2649 && dir == W) { i = ((x-1)/16) - 3; j = y/16;}
                    if (getSol(x + 16, y + 16) == 2655 && dir == E) { i = (x+16)/16; j = y/16;}
                    break;
                case 22 :
                    if (getSol(x, y + 7) == 2848 && dir == N) { i = x/16; j = ((y + 7)/16) - 3;}
                    if (getSol(x, y + 24) == 2850 && dir == S) { i = x/16; j = (y + 24)/16;}
                    if (getSol(x - 1, y + 16) == 2857 && dir == W) { i = ((x-1)/16) - 3; j = y/16;}
                    if (getSol(x + 16, y + 16) == 2862 && dir == E) { i = (x+16)/16; j = y/16;}
                    break;
                case 23 :
                    if (getSol(x, y + 7) == 3094 && dir == N) { i = x/16; j = ((y + 7)/16) - 3;}
                    if (getSol(x, y + 24) == 3096 && dir == S) { i = x/16; j = (y + 24)/16;}
                    if (getSol(x - 1, y + 16) == 3103 && dir == W) { i = ((x-1)/16) - 3; j = y/16;}
                    if (getSol(x + 16, y + 16) == 3108 && dir == E) { i = (x+16)/16; j = y/16;}
                    break;
                case 24 :
                    if (getSol(x - 1, y + 16) == 3258 && dir == W) { i = ((x-1)/16) - 3; j = y/16;}
                    if (getSol(x + 16, y + 16) == 3263 && dir == E) { i = (x+16)/16; j = y/16;}
                    break;
                case 25 :
                    if (getSol(x, y + 7) == 3428 && dir == N) { i = x/16; j = ((y + 7)/16) - 3;}
                    if (getSol(x, y + 24) == 3430 && dir == S) { i = x/16; j = (y + 24)/16;}
                    if (getSol(x - 1, y + 16) == 3437 && dir == W) { i = ((x-1)/16) - 3; j = y/16;}
                    if (getSol(x + 16, y + 16) == 3442 && dir == E) { i = (x+16)/16; j = y/16;}
                    break;
                case 26 :
                    if ((getSol(x, y + 7) == 3716 || getSol(x, y + 7) == 3873) && dir == N) { i = x/16; j = ((y + 7)/16) - 3;}
                    if (getSol(x, y + 24) == 3718 && dir == S) { i = x/16; j = (y + 24)/16;}
                    if (getSol(x - 1, y + 16) == 3725 && dir == W) { i = ((x-1)/16) - 3; j = y/16;}
                    if (getSol(x + 16, y + 16) == 3730 && dir == E) { i = (x+16)/16; j = y/16;}
                    break;
                case 27 :
                    if (getSol(x, y + 7) == 3968 && dir == N) { i = x/16; j = ((y + 7)/16) - 3;}
                    if (getSol(x, y + 24) == 3970 && dir == S) { i = x/16; j = (y + 24)/16;}
                    if (getSol(x - 1, y + 16) == 3977 && dir == W) { i = ((x-1)/16) - 3; j = y/16;}
                    if (getSol(x + 16, y + 16) == 3982 && dir == E) { i = (x+16)/16; j = y/16;}
                    break;
                case 28 :
                    if (getSol(x, y + 7) == 4099 && dir == N) { i = x/16; j = ((y + 7)/16) - 3;}
                    if (getSol(x, y + 24) == 4101 && dir == S) { i = x/16; j = (y + 24)/16;}
                    if (getSol(x - 1, y + 16) == 4108 && dir == W) { i = ((x-1)/16) - 3; j = y/16;}
                    if (getSol(x + 16, y + 16) == 4113 && dir == E) { i = (x+16)/16; j = y/16;}
                    break;
            }
            ...
            if (i != 0) {
                ...
                switch (map) {
                    case 15 :
                        ...
                        else if (bounds.getX() == 320*5) k = 10;
                        else k = 11;
                        break;
                    case 16 :
                        if (bounds.getX() == 320*5) k = 9;
                        else if (bounds.getY() == 240*4 && scene->getLink()->getX() < 129*16) k = 10;
                        else if (bounds.getY() == 240*5) k = 11;
                        else if (bounds.getY() == 240*4 && scene->getLink()->getX() >= 129*16) k = 12;
                        else k = 13;
                        break;
                    case 17 :
                        if (bounds.getY() == 240) k = 8;
                        else if (bounds.getY() == 240*3) k = 9;
                        else if (bounds.getY() == 240*5) k = 10;
                        else k = 11;
                        break;
                    case 18 :
                        if (bounds.getX() == 320*5 && bounds.getY() == 240) k = 12;
                        else if (bounds.getX() == 320*5 && bounds.getY() == 240*3) k = 13;
                        else if (bounds.getX() == 320*6 && bounds.getY() == 240*2) k = 14;
                        else if (bounds.getX() == 320*6 && bounds.getY() == 0) k = 15;
                        else if (bounds.getX() == 320*13 && bounds.getY() == 240*2) k = 16;
                        else if (bounds.getX() == 320*14 && bounds.getY() == 240*4) k = 17;
                        else if (bounds.getX() == 320*14 && bounds.getY() == 240*2 && scene->getLink()->getX() < 299*16) k = 18;
                        else k = 19;
                        break;
                    case 19 :
                        if (bounds.getX() == 320*2 && bounds.getY() == 240*3) k = 9;
                        else if (bounds.getX() == 320*2 && bounds.getY() == 240*4) k = 10;
                        else if (bounds.getX() == 320*7 && bounds.getY() == 240*2) k = 11;
                        else if (bounds.getX() == 320*7 && bounds.getY() == 0) k = 12;
                        else k = 13;
                        break;
                    case 20 :
                        if (bounds.getX() == 320*4 && bounds.getY() == 240*3 && scene->getLink()->getX() < 90*16) k = 18;
                        else if (bounds.getX() == 320*4 && bounds.getY() == 240*2 && scene->getLink()->getX() < 90*16 && scene->getLink()->getY() > 37*16) k = 19;
                        else if (bounds.getX() == 320*3 && bounds.getY() == 240*2) k = 20;
                        else if (bounds.getX() == 320*4 && bounds.getY() == 240*2 && scene->getLink()->getX() < 90*16 && scene->getLink()->getY() < 37*16) k = 21;
                        else if (bounds.getX() == 320*4 && bounds.getY() == 240 && scene->getLink()->getX() < 90*16 && scene->getLink()->getY() > 22*16) k = 22;
                        else if (bounds.getX() == 320*3 && bounds.getY() == 240) k = 23;
                        else if (bounds.getX() == 320*4 && bounds.getY() == 240 && scene->getLink()->getX() < 90*16 && scene->getLink()->getY() < 22*16) k = 24;
                        else if (bounds.getX() == 320*4 && bounds.getY() == 0) k = 25;
                        else if (bounds.getX() == 320*4 && bounds.getY() == 240 && scene->getLink()->getX() > 90*16 && scene->getLink()->getY() < 22*16) k = 26;
                        else if (bounds.getX() == 320*5 && bounds.getY() == 240) k = 27;
                        else if (bounds.getX() == 320*4 && bounds.getY() == 240 && scene->getLink()->getX() > 90*16 && scene->getLink()->getY() > 22*16) k = 28;
                        else if (bounds.getX() == 320*4 && bounds.getY() == 240*2 && scene->getLink()->getX() > 90*16 && scene->getLink()->getY() < 37*16) k = 29;
                        else if (bounds.getX() == 320*5 && bounds.getY() == 240*2) k = 30;
                        else k = 31;
                        break;
                    case 21 :
                        if (bounds.getX() == 320 && bounds.getY() == 240*2) k = 11;
                        else if (bounds.getX() == 320 && bounds.getY() == 240) k = 12;
                        else if (bounds.getX() == 320*6 && bounds.getY() == 240) k = 13;
                        else if (bounds.getX() == 320*7 && bounds.getY() == 240*3) k = 14;
                        else if (bounds.getX() == 320*8 && bounds.getY() == 240*3) k = 15;
                        else if (bounds.getX() == 320*10 && bounds.getY() == 240*2) k = 16;
                        else k = 17;
                        break;
                    case 22 :
                        if (bounds.getX() == 320 && bounds.getY() == 240*2 && scene->getLink()->getX() < 55*16) k = 10;
                        else if (bounds.getX() == 320 && bounds.getY() == 240*2 && scene->getLink()->getX() > 55*16) k = 11;
                        else if (bounds.getX() == 320*5 && bounds.getY() == 240*5 && scene->getLink()->getX() < 120*16) k = 12;
                        else if (bounds.getX() == 320*6 && bounds.getY() == 240 && scene->getLink()->getX() < 140*16) k = 13;
                        else if (bounds.getX() == 320*5 && bounds.getY() == 240*5 && scene->getLink()->getX() > 120*16) k = 14;
                        else k = 15;
                        break;
                    case 23 :
                        if (bounds.getX() == 320*2) k = 8;
                        else if (bounds.getY() == 240*4) k = 9;
                        else if (bounds.getX() == 320*8) k = 11;
                        else k = 10;
                        break;
                    case 24 :
                        if (bounds.getX() == 320) k = 9;
                        else if (bounds.getX() == 0) k = 10;
                        else if (bounds.getX() == 320*3) k = 11;
                        else if (bounds.getX() == 320*7) k = 12;
                        else k = 13;
                        break;
                    case 25 :
                        if (bounds.getX() == 0) k = 9;
                        else if (bounds.getX() == 320 && scene->getLink()->getX() < 25*16) k = 10;
                        else if (bounds.getX() == 320 && bounds.getY() == 240*3) k = 11;
                        else if (bounds.getX() == 320) k = 12;
                        else k = 13;
                        break;
                    case 26 :
                        if (bounds.getX() == 320) k = 9;
                        else if (bounds.getX() == 320*3 && scene->getLink()->getX() < 70*16) k = 10;
                        else if (bounds.getX() == 320*3) k = 11;
                        else if (bounds.getX() == 320*5) k = 12;
                        else k = 13;
                        break;
                    case 27 :
                        if (bounds.getX() == 320) k = 8;
                        ...
                        break;
                    case 28 :
                        if (bounds.getX() == 320*2) k = 7;
                        else if (bounds.getX() == 320*3) k = 8;
                        else k = 9;
                        break;
                }
                if (k != 0) {
        ...
        if (scene->getCoffre(map - 14, 2) == 1 && dir == N) {
            int value = false;
            switch (map) {
                case 15 : value = 1719; break;
                case 16 : case 20 : value = 1934; break;
                case 17 : value = 2062; break;
                case 18 : value = 2274; break;
                case 19 : value = 2461; break;
                case 21 : value = 2668; break;
                case 22 : value = 2888; break;
                case 23 : value = 3134; break;
                case 24 : value = 3289; break;
                case 25 : value = 3468; break;
                case 26 : value = 3889; break;
                case 27 : value = 4008; break;
                case 28 : value = 4139; break;
            }
...
void Map::permuteBlocs(int step) {
    ...
    switch (map) { // 624 to 627, orange = 624, blue = 625, +2 = up
        case 7 :
            if (step == 0) {
...
void Map::ouvrePorte(int x, int y, int type) {
    ...
    switch (map) {
        ...
        case 15 :
            if (type == 0) {
                sol[x][y]=1669; sol[x + 1][y]=1670;
                sol[x][y + 1]=1671; sol[x + 1][y + 1]=1672;
                sol[x][y + 2]=1664; sol[x + 1][y + 2]=1665;
                sol[x][y + 3]=1666; sol[x + 1][y + 3]=1667;
        ...
        case 16 : case 20 :
            if (type == 0) {
                sol[x][y]=1874; sol[x + 1][y]=1875;
                sol[x][y + 1]=1876; sol[x + 1][y + 1]=1877;
                sol[x][y + 2]=1868; sol[x + 1][y + 2]=1869;
                sol[x][y + 3]=1870; sol[x + 1][y + 3]=1871;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
        ...
        case 17 :
            if (type == 0) {
                sol[x][y]=2032; sol[x + 1][y]=2033;
                sol[x][y + 1]=2034; sol[x + 1][y + 1]=2035;
                sol[x][y + 2]=2026; sol[x + 1][y + 2]=2027;
                sol[x][y + 3]=2028; sol[x + 1][y + 3]=2029;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
                ...
                sol[x][y]=2094; sol[x + 1][y]=2095;
                sol[x][y + 1]=2096; sol[x + 1][y + 1]=2097; air[x][y + 1]=2098; air[x + 1][y + 1]=2099;
                sol[x][y + 2]=2088; sol[x + 1][y + 2]=2089; air[x][y + 2]=2092; air[x + 1][y + 2]=2093;
                sol[x][y + 3]=2090; sol[x + 1][y + 3]=2091;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
                ...
                sol[x][y+2]=2111;
                sol[x+1][y]=2108;
                sol[x+1][y+1]=2110; air[x+1][y+1]=2113;
                sol[x+1][y+2]=2112;

                sol[x+2][y]=2100;
                sol[x+2][y+1]=2102; air[x+2][y+1]=2106;
                sol[x+2][y+2]=2104;
                sol[x+3][y]=2101;
                sol[x+3][y+1]=2103;
                sol[x+3][y+2]=2105;
                ...
                sol[x][y]=2151; sol[x + 1][y]=2153;
                sol[x][y + 1]=2156; sol[x + 1][y + 1]=2158;
        ...
        case 18 :
            if (type == 0) {
                sol[x][y]=2232; sol[x + 1][y]=2233;
                sol[x][y + 1]=2234; sol[x + 1][y + 1]=2235;
                sol[x][y + 2]=2226; sol[x + 1][y + 2]=2227;
                sol[x][y + 3]=2228; sol[x + 1][y + 3]=2229;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
                ...
                sol[x][y]=2310; sol[x + 1][y]=2311;
                sol[x][y + 1]=2312; sol[x + 1][y + 1]=2313; air[x][y + 1]=2314; air[x + 1][y + 1]=2315;
                sol[x][y + 2]=2304; sol[x + 1][y + 2]=2305; air[x][y + 2]=2308; air[x + 1][y + 2]=2309;
                sol[x][y + 3]=2306; sol[x + 1][y + 3]=2307;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
                ...
                sol[x][y]=2324; sol[x + 1][y]=2326;
                sol[x][y + 1]=2329; sol[x + 1][y + 1]=2331;
                mur[x * 2][y * 2] = TROU; mur[x * 2 + 1][y * 2] = TROU;
                mur[x * 2][y * 2 + 1] = TROU; mur[x * 2 + 1][y * 2 + 1] = TROU;
                mur[x * 2][y * 2 + 2] = TROU; mur[x * 2 + 1][y * 2 + 2] = TROU;
                mur[x * 2][y * 2 + 3] = TROU; mur[x * 2 + 1][y * 2 + 3] = TROU;
        ...
        case 19 :
            if (type == 0) {
                sol[x][y]=2419; sol[x + 1][y]=2420;
                sol[x][y + 1]=2421; sol[x + 1][y + 1]=2422;
                sol[x][y + 2]=2413; sol[x + 1][y + 2]=2414;
                sol[x][y + 3]=2415; sol[x + 1][y + 3]=2416;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
                ...
                sol[x][y+2]=2496;
                sol[x+1][y]=2493;
                sol[x+1][y+1]=2495; air[x+1][y+1]=2498;
                sol[x+1][y+2]=2497;

                sol[x+2][y]=2485;
                sol[x+2][y+1]=2487; air[x+2][y+1]=2491;
                sol[x+2][y+2]=2489;
                sol[x+3][y]=2486;
                sol[x+3][y+1]=2488;
                sol[x+3][y+2]=2490;
        ...
        case 21 :
            if (type == 0) {
                sol[x][y]=2615; sol[x + 1][y]=2616;
                sol[x][y + 1]=2617; sol[x + 1][y + 1]=2618;
                sol[x][y + 2]=2610; sol[x + 1][y + 2]=2611;
                sol[x][y + 3]=2612; sol[x + 1][y + 3]=2613;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
        ...
        case 22 :
            if (type == 0) {
                sol[x][y]=(x < 160) ? 2826 : 2978; sol[x + 1][y]=(x < 160) ? 2827 : 2979;
                sol[x][y + 1]=(x < 160) ? 2828 : 2980; sol[x + 1][y + 1]=(x < 160) ? 2829 : 2981;
                sol[x][y + 2]=(x < 160) ? 2820 : 2972; sol[x + 1][y + 2]=(x < 160) ? 2821 : 2973;
                sol[x][y + 3]=(x < 160) ? 2822 : 2974; sol[x + 1][y + 3]=(x < 160) ? 2823 : 2975;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
                ...
                sol[x][y]=2908; sol[x + 1][y]=2909;
                sol[x][y + 1]=2910; sol[x + 1][y + 1]=2911; air[x][y + 1]=2912; air[x + 1][y + 1]=2913;
                sol[x][y + 2]=2902; sol[x + 1][y + 2]=2903; air[x][y + 2]=2906; air[x + 1][y + 2]=2907;
                sol[x][y + 3]=2904; sol[x + 1][y + 3]=2905;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
                ...
                sol[x][y+2]=2925;
                sol[x+1][y]=2922;
                sol[x+1][y+1]=2924; air[x+1][y+1]=2927;
                sol[x+1][y+2]=2926;

                sol[x+2][y]=2914;
                sol[x+2][y+1]=2916; air[x+2][y+1]=2920;
                sol[x+2][y+2]=2918;
                sol[x+3][y]=2915;
                sol[x+3][y+1]=2917;
                sol[x+3][y+2]=2919;
        ...
        case 23 :
            if (type == 0) {
                sol[x][y]=3072; sol[x + 1][y]=3073;
                sol[x][y + 1]=3074; sol[x + 1][y + 1]=3075;
                sol[x][y + 2]=3066; sol[x + 1][y + 2]=3067;
                sol[x][y + 3]=3068; sol[x + 1][y + 3]=3069;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
                ...
                sol[x][y+2]=3158;
                sol[x+1][y]=3155;
                sol[x+1][y+1]=3157; air[x+1][y+1]=3160;
                sol[x+1][y+2]=3159;

                sol[x+2][y]=3147;
                sol[x+2][y+1]=3149; air[x+2][y+1]=3153;
                sol[x+2][y+2]=3151;
                sol[x+3][y]=3148;
                sol[x+3][y+1]=3150;
                sol[x+3][y+2]=3152;
                ...
                sol[x][y]=3161; sol[x + 1][y]=3163;
                sol[x][y + 1]=3166; sol[x + 1][y + 1]=3168;
                mur[x * 2][y * 2] = TROU; mur[x * 2 + 1][y * 2] = TROU;
                mur[x * 2][y * 2 + 1] = TROU; mur[x * 2 + 1][y * 2 + 1] = TROU;
                mur[x * 2][y * 2 + 2] = TROU; mur[x * 2 + 1][y * 2 + 2] = TROU;
                mur[x * 2][y * 2 + 3] = TROU; mur[x * 2 + 1][y * 2 + 3] = TROU;
        ...
        case 24 :
            if (type == 0) {
                sol[x][y]=3237; sol[x + 1][y]=3238;
                sol[x][y + 1]=3239; sol[x + 1][y + 1]=3240;
                sol[x][y + 2]=3231; sol[x + 1][y + 2]=3232;
                sol[x][y + 3]=3233; sol[x + 1][y + 3]=3234;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
                ...
                sol[x][y]=3309; sol[x + 1][y]=3310;
                sol[x][y + 1]=3311; sol[x + 1][y + 1]=3312; air[x][y + 1]=3313; air[x + 1][y + 1]=3314;
                sol[x][y + 2]=3303; sol[x + 1][y + 2]=3304; air[x][y + 2]=3307; air[x + 1][y + 2]=3308;
                sol[x][y + 3]=3305; sol[x + 1][y + 3]=3306;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
                ...
                sol[x][y+2]=3326;
                sol[x+1][y]=3323;
                sol[x+1][y+1]=3325; air[x+1][y+1]=3328;
                sol[x+1][y+2]=3327;

                sol[x+2][y]=3315;
                sol[x+2][y+1]=3317; air[x+2][y+1]=3321;
                sol[x+2][y+2]=3319;
                sol[x+3][y]=3316;
                sol[x+3][y+1]=3318;
                sol[x+3][y+2]=3320;
                ...
                sol[x][y]=3329; sol[x + 1][y]=3331;
                sol[x][y + 1]=3334; sol[x + 1][y + 1]=3336;
                mur[x * 2][y * 2] = TROU; mur[x * 2 + 1][y * 2] = TROU;
                mur[x * 2][y * 2 + 1] = TROU; mur[x * 2 + 1][y * 2 + 1] = TROU;
                mur[x * 2][y * 2 + 2] = TROU; mur[x * 2 + 1][y * 2 + 2] = TROU;
                mur[x * 2][y * 2 + 3] = TROU; mur[x * 2 + 1][y * 2 + 3] = TROU;
        ...
        case 25 :
            if (type == 0) {
                sol[x][y]=3406; sol[x + 1][y]=3407;
                sol[x][y + 1]=3408; sol[x + 1][y + 1]=3409;
                sol[x][y + 2]=3400; sol[x + 1][y + 2]=3401;
                sol[x][y + 3]=3402; sol[x + 1][y + 3]=3403;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
                ...
                sol[x][y]=3488; sol[x + 1][y]=3489;
                sol[x][y + 1]=3490; sol[x + 1][y + 1]=3491; air[x][y + 1]=3492; air[x + 1][y + 1]=3493;
                sol[x][y + 2]=3482; sol[x + 1][y + 2]=3483; air[x][y + 2]=3486; air[x + 1][y + 2]=3487;
                sol[x][y + 3]=3484; sol[x + 1][y + 3]=3485;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
                ...
                sol[x][y+2]=3505;
                sol[x+1][y]=3502;
                sol[x+1][y+1]=3504; air[x+1][y+1]=3507;
                sol[x+1][y+2]=3506;

                sol[x+2][y]=3494;
                sol[x+2][y+1]=3496; air[x+2][y+1]=3500;
                sol[x+2][y+2]=3498;
                sol[x+3][y]=3495;
                sol[x+3][y+1]=3497;
                sol[x+3][y+2]=3499;
        ...
        case 26 :
            if (type == 0) {
                sol[x][y]=x < 280 ? 3694 : 3851; sol[x + 1][y]=x < 280 ? 3695 : 3852;
                sol[x][y + 1]=x < 280 ? 3696 : 3853; sol[x + 1][y + 1]=x < 280 ? 3697 : 3854;
                sol[x][y + 2]=x < 280 ? 3688 : 3845; sol[x + 1][y + 2]=x < 280 ? 3689 : 3846;
                sol[x][y + 3]=x < 280 ? 3690 : 3847; sol[x + 1][y + 3]=x < 280 ? 3691 : 3848;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
                ...
                sol[x][y+2]=3767;
                sol[x+1][y]=3764;
                sol[x+1][y+1]=3766; air[x+1][y+1]=3769;
                sol[x+1][y+2]=3768;

                sol[x+2][y]=3756;
                sol[x+2][y+1]=3758; air[x+2][y+1]=3762;
                sol[x+2][y+2]=3760;
                sol[x+3][y]=3757;
                sol[x+3][y+1]=3759;
                sol[x+3][y+2]=3761;
        ...
        case 27 :
            if (type == 0) {
                sol[x][y]=3946; sol[x + 1][y]=3947;
                sol[x][y + 1]=3948; sol[x + 1][y + 1]=3949;
                sol[x][y + 2]=3940; sol[x + 1][y + 2]=3941;
                sol[x][y + 3]=3942; sol[x + 1][y + 3]=3943;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
                ...
                sol[x][y]=4018; sol[x + 1][y]=4019;
                sol[x][y + 1]=4020; sol[x + 1][y + 1]=4021; air[x][y + 1]=4022; air[x + 1][y + 1]=4023;
                sol[x][y + 2]=4012; sol[x + 1][y + 2]=4013; air[x][y + 2]=4016; air[x + 1][y + 2]=4017;
                sol[x][y + 3]=4014; sol[x + 1][y + 3]=4015;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
        ...
        case 28 :
            if (type == 0) {
                sol[x][y]=4077; sol[x + 1][y]=4078;
                sol[x][y + 1]=4079; sol[x + 1][y + 1]=4080;
                sol[x][y + 2]=4071; sol[x + 1][y + 2]=4072;
                sol[x][y + 3]=4073; sol[x + 1][y + 3]=4074;
                mur[x * 2 + 1][y * 2 + 1] = PIERRE; mur[x * 2 + 2][y * 2 + 1] = PIERRE;
                mur[x * 2 + 1][y * 2 + 2] = PIERRE; mur[x * 2 + 2][y * 2 + 2] = PIERRE;
                mur[x * 2 + 1][y * 2 + 3] = PIERRE; mur[x * 2 + 2][y * 2 + 3] = PIERRE;
                mur[x * 2 + 1][y * 2 + 4] = PIERRE; mur[x * 2 + 2][y * 2 + 4] = PIERRE;
            ...
            break;
        case 45 :
            sol[x][y]=1868; sol[x + 1][y]=1869;
            sol[x][y + 1]=1870; sol[x + 1][y + 1]=1871;
            mur[x * 2 + 1][y * 2] = TERRE; mur[x * 2 + 2][y * 2] = TERRE;
            mur[x * 2 + 1][y * 2 + 1] = TERRE; mur[x * 2 + 2][y * 2 + 1] = TERRE;
            mur[x * 2 + 1][y * 2 + 2] = TERRE; mur[x * 2 + 2][y * 2 + 2] = TERRE;
            break;
    }
...
void Map::fermePorte(int x, int y, int type) {
    switch (map) {
        case 15 :
            if (type == 0) {
                sol[x][y]=1725; sol[x + 1][y]=1726;
                sol[x][y + 1]=1727; sol[x + 1][y + 1]=1728;
        ...
        case 16 : case 20 :
            if (type == 0) {
                sol[x][y]=1916; sol[x + 1][y]=1917;
                sol[x][y + 1]=1918; sol[x + 1][y + 1]=1919;
                mur[x * 2 + 1][y * 2 + 1] = MUR; mur[x * 2 + 2][y * 2 + 1] = MUR;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 1][y * 2 + 4] = MUR; mur[x * 2 + 2][y * 2 + 4] = MUR;
        ...
        case 17 :
            if (type == 0) {
                sol[x][y]=2068; sol[x + 1][y]=2069;
                sol[x][y + 1]=2070; sol[x + 1][y + 1]=2071;
                mur[x * 2 + 1][y * 2 + 1] = MUR; mur[x * 2 + 2][y * 2 + 1] = MUR;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 1][y * 2 + 4] = MUR; mur[x * 2 + 2][y * 2 + 4] = MUR;
        ...
        case 18 :
            if (type == 0) {
                sol[x][y]=2280; sol[x + 1][y]=2281;
                sol[x][y + 1]=2282; sol[x + 1][y + 1]=2283;
                mur[x * 2 + 1][y * 2 + 1] = MUR; mur[x * 2 + 2][y * 2 + 1] = MUR;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 1][y * 2 + 4] = MUR; mur[x * 2 + 2][y * 2 + 4] = MUR;
        ...
        case 19 :
            if (type == 0) {
                sol[x][y]=2467; sol[x + 1][y]=2468;
                sol[x][y + 1]=2469; sol[x + 1][y + 1]=2470;
                mur[x * 2 + 1][y * 2 + 1] = MUR; mur[x * 2 + 2][y * 2 + 1] = MUR;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 1][y * 2 + 4] = MUR; mur[x * 2 + 2][y * 2 + 4] = MUR;
        ...
        case 21 :
            if (type == 0) {
                sol[x][y]=2674; sol[x + 1][y]=2675;
                sol[x][y + 1]=2676; sol[x + 1][y + 1]=2677;
                mur[x * 2 + 1][y * 2 + 1] = MUR; mur[x * 2 + 2][y * 2 + 1] = MUR;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 1][y * 2 + 4] = MUR; mur[x * 2 + 2][y * 2 + 4] = MUR;
        ...
        case 22 :
            if (type == 0) {
                sol[x][y]=2870; sol[x + 1][y]=2871;
                sol[x][y + 1]=2872; sol[x + 1][y + 1]=2873;
                mur[x * 2 + 1][y * 2 + 1] = MUR; mur[x * 2 + 2][y * 2 + 1] = MUR;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 1][y * 2 + 4] = MUR; mur[x * 2 + 2][y * 2 + 4] = MUR;
        ...
        case 23 :
            if (type == 0) {
                sol[x][y]=3116; sol[x + 1][y]=3117;
                sol[x][y + 1]=3118; sol[x + 1][y + 1]=3119;
                mur[x * 2 + 1][y * 2 + 1] = MUR; mur[x * 2 + 2][y * 2 + 1] = MUR;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 1][y * 2 + 4] = MUR; mur[x * 2 + 2][y * 2 + 4] = MUR;
        ...
        case 24 :
            if (type == 0) {
                sol[x][y]=3271; sol[x + 1][y]=3272;
                sol[x][y + 1]=3273; sol[x + 1][y + 1]=3274;
                sol[x][y + 2]=3267; sol[x + 1][y + 2]=3268;
                sol[x][y + 3]=3269; sol[x + 1][y + 3]=3270;
                mur[x * 2 + 1][y * 2 + 1] = MUR; mur[x * 2 + 2][y * 2 + 1] = MUR;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 1][y * 2 + 4] = MUR; mur[x * 2 + 2][y * 2 + 4] = MUR;
        ...
        case 25 :
            if (type == 0) {
                sol[x][y]=3450; sol[x + 1][y]=3451;
                sol[x][y + 1]=3452; sol[x + 1][y + 1]=3453;
                mur[x * 2 + 1][y * 2 + 1] = MUR; mur[x * 2 + 2][y * 2 + 1] = MUR;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 1][y * 2 + 4] = MUR; mur[x * 2 + 2][y * 2 + 4] = MUR;
        ...
        case 26 :
            if (type == 0) {
                sol[x][y]=3883; sol[x + 1][y]=3884;
                sol[x][y + 1]=3885; sol[x + 1][y + 1]=3886;
                mur[x * 2 + 1][y * 2 + 1] = MUR; mur[x * 2 + 2][y * 2 + 1] = MUR;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 1][y * 2 + 4] = MUR; mur[x * 2 + 2][y * 2 + 4] = MUR;
        ...
        case 27 :
            if (type == 0) {
                sol[x][y]=3990; sol[x + 1][y]=3991;
                sol[x][y + 1]=3992; sol[x + 1][y + 1]=3993;
                mur[x * 2 + 1][y * 2 + 1] = MUR; mur[x * 2 + 2][y * 2 + 1] = MUR;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 1][y * 2 + 4] = MUR; mur[x * 2 + 2][y * 2 + 4] = MUR;
        ...
        case 28 :
            if (type == 0) {
                sol[x][y]=4121; sol[x + 1][y]=4122;
                sol[x][y + 1]=4123; sol[x + 1][y + 1]=4124;
                mur[x * 2 + 1][y * 2 + 1] = MUR; mur[x * 2 + 2][y * 2 + 1] = MUR;
                mur[x * 2 + 1][y * 2 + 2] = MUR; mur[x * 2 + 2][y * 2 + 2] = MUR;
                mur[x * 2 + 1][y * 2 + 3] = MUR; mur[x * 2 + 2][y * 2 + 3] = MUR;
                mur[x * 2 + 1][y * 2 + 4] = MUR; mur[x * 2 + 2][y * 2 + 4] = MUR;
...
void Map::songPlayed(int id) {
    ...
    switch (id) {
        case 0 :
            if (map == 14 && !scene->getCoffre(0, 10)
                && (link->getX() > 92 * 16 && link->getX() < 97 * 16)
                && (link->getY() > 37 * 16 + 8 && link->getY() < 42 * 16 + 8)) {
                removeStele();
            }
            break;
        case 1 :
...
bool Map::isVillage(BoundingBox* box) {
    if (map >= 46 && map <= 70 && map != 61) return true; //maisons des villages
    BoundingBox tmp;
    switch (map) {
        case 3 :
            tmp.setX(7*16); tmp.setY(12*16); tmp.setW(71*16); tmp.setH(42*16);
            if (tmp.intersect(box)) return true;
            tmp.setX(17*16); tmp.setY(9*16); tmp.setW(47*16); tmp.setH(3*16);
            return tmp.intersect(box);
        case 7 :
            tmp.setX(11*16); tmp.setY(13*16); tmp.setW(63*16); tmp.setH(29*16);
            if (tmp.intersect(box)) return true;
            tmp.setX(31*16); tmp.setY(3*16); tmp.setW(34*16); tmp.setH(10*16);
            return tmp.intersect(box);
        case 11 :
            tmp.setX(8*16); tmp.setY(8*16); tmp.setW(64*16); tmp.setH(36*16);
            return tmp.intersect(box);
        case 13 :
            tmp.setX(24*16); tmp.setY(21*16); tmp.setW(40*16); tmp.setH(21*16);
            return tmp.intersect(box);
    }
    return false;
}
...
int Map::getEtage() {
    switch (map) {
        case 15 : case 16 : case 19 : case 21 : return -(bounds.getX() / (100 * 16));
        case 17 :
            if (bounds.getX() == 0) return 1;
            if (bounds.getX() < 320 * 6) return 0;
            return -1;
        case 18 :
            if (bounds.getX() < 320 * 3) return 2;
            if (bounds.getX() < 320 * 6) return 1;
            if (bounds.getX() < 320 * 11) return 0;
            return -1;
        case 20 :
            if (bounds.getX() == 0) return 1;
            if (bounds.getX() < 320 * 8) return 0;
            return -1;
        case 22 : return 1-(bounds.getX() / (80 * 16));
        case 23 :
            if (bounds.getX() == 0 && bounds.getY() == 240 * 4) return 2;
            if (bounds.getX() < 320 * 3) return 1;
            if (bounds.getX() < 320 * 8) return 0;
            if (bounds.getX() < 320 * 13) return -1;
            return -2;
        case 24 : return 1-(bounds.getX() / (100 * 16));
        case 25 :
            if (bounds.getX() > 160 * 16 && bounds.getY() < 60 * 16) return 3;
            if (bounds.getY() < 60 * 16) return 2 - (bounds.getX() / (80 * 16));
            return -(bounds.getX() / (80 * 16));
        case 26 : return -(bounds.getX() / (140 * 16));
        case 27 : return 0;
        case 28 :
            if (bounds.getX() > 100 * 16 && bounds.getY() > 75 * 16) return 3;
            if (bounds.getY() < 75 * 16) return 2 - (bounds.getX() / (100 * 16));
            return 0;
        case 34 : case 40 : return (bounds.getX() / (40 * 16));
        case 41 :
            if (bounds.getX() == 0) return 0;
            return -1;
        default : return 0;
    }
}

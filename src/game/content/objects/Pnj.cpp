...
int Pnj::getDynamicText()
{
    ...
    case 320:
        ...
        break;
    case 324:
        if ((scene->getCoffre(2, 5) && x == 16 * 174) || (scene->getCoffre(2, 6) && x == 16 * 185) || (scene->getCoffre(2, 7) && x == 16 * 194))
        {
            return 200;
        }
        break;
    ...
    case 332:
        ...
        break;
    case 347:
        if ((scene->getCoffre(9, 27) && scene->getMap()->getId() == 23) || (scene->getCoffre(10, 27) && scene->getMap()->getId() == 24) || (scene->getCoffre(11, 24) && scene->getMap()->getId() == 25))
        {
            return 200;
        }
        break;

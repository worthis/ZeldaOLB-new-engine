...
void Ocarina::handleActions(Action *action)
{
    if (action->isAction(ACTION))
    {
        ...
        case 0:
            ...
            break;
        case 1:
            if (!inventory->hasObject(CHANT_2))
                return;
            break;
        case 2:
...
void Ocarina::start()
{
    ...
    {
    case 0:
        AudioManager::getInstance()->playSound(TS_SONG_1, 1);
        break;
    case 1:
        AudioManager::getInstance()->playSound(TS_SONG_2, 1);
        break;
    case 2:
        AudioManager::getInstance()->playSound(TS_SONG_3, 1);
        break;
    default:
        AudioManager::getInstance()->playSound(TS_SONG_1, 1);
        break;
...
void Ocarina::stop()
{
    ...
    case 0:
        if (!inventory->hasObject(CHANT_1))
            link->trouveObjet(TI_CHANT_1);
        break;
    case 1:
        if (!inventory->hasObject(CHANT_2))
            link->trouveObjet(TI_CHANT_2);
        break;
    case 2:
        if (!inventory->hasObject(CHANT_3))
            link->trouveObjet(TI_CHANT_3);
        break;
    default:
        break;
    }

...
void Monsters::initPage() {
    ...
    switch (page) {
        case 0 :
            ...
            if (scene->getMonsters(30) && !ennemis[30]) ennemis[30] = (Ennemi*)(new Ennemi030(256 + 16, 112 + 12));
        ...
        case 1 :
            ...
            if (scene->getMonsters(26) && !ennemis[26]) ennemis[26] = (Ennemi*)(new Ennemi026(208 + 9, 8 + 6));
            ...
            if (scene->getMonsters(16) && !ennemis[16]) ennemis[16] = (Ennemi*)(new Ennemi016(176 + 16, 112 + 12));
            ...
            if (scene->getMonsters(64) && !ennemis[64]) ennemis[64] = (Ennemi*)(new Ennemi064(252 + 8, 176 + 6));
            break;
        case 2 :
            if (scene->getMonsters(11) && !ennemis[11]) ennemis[11] = (Ennemi*)(new Ennemi011(152 + 8, 8 + 8, true));
            if (scene->getMonsters(12) && !ennemis[12]) ennemis[12] = (Ennemi*)(new Ennemi012(208 + 9, 8 + 8));
            if (scene->getMonsters(56) && !ennemis[56]) ennemis[56] = (Ennemi*)(new Ennemi056(264 + 9, 8 + 8));
            if (scene->getMonsters(33) && !ennemis[33]) ennemis[33] = (Ennemi*)(new Ennemi033(16 + 13, 48 + 12));
            if (scene->getMonsters(34) && !ennemis[34]) ennemis[34] = (Ennemi*)(new Ennemi034(96 + 12, 48 + 12));
            if (scene->getMonsters(38) && !ennemis[38]) ennemis[38] = (Ennemi*)(new Ennemi038(176 + 13, 48 + 12));
            if (scene->getMonsters(39) && !ennemis[39]) ennemis[39] = (Ennemi*)(new Ennemi039(256 + 12, 48 + 12));
            if (scene->getMonsters(72) && !ennemis[72]) ennemis[72] = (Ennemi*)(new Ennemi072(16 + 16, 112 + 12));
            if (scene->getMonsters(55) && !ennemis[55]) ennemis[55] = (Ennemi*)(new Ennemi055(96 + 13, 112 + 8));
            ...
            if (scene->getMonsters(75) && !ennemis[75]) ennemis[75] = (Ennemi*)(new Ennemi075(176 + 15, 176 + 10));
            break;
        case 3 :
            if (scene->getMonsters(57) && !ennemis[57]) ennemis[57] = (Ennemi*)(new Ennemi057(16 + 8, 48 + 7, 0));
            if (scene->getMonsters(60) && !ennemis[60]) ennemis[60] = (Ennemi*)(new Ennemi060(16 + 7, 144 + 7));
            if (scene->getMonsters(62) && !ennemis[62]) ennemis[62] = (Ennemi*)(new Ennemi062(240 + 12, 112 + 10, false));
            if (scene->getMonsters(28) && !ennemis[28]) ennemis[28] = (Ennemi*)(new Ennemi028(240 + 8, 184 + 4));
            if (scene->getMonsters(45) && !ennemis[45]) ennemis[45] = (Ennemi*)(new Ennemi045(224 + 7, 8 + 6));
            if (scene->getMonsters(40) && !ennemis[40]) ennemis[40] = (Ennemi*)(new Ennemi040(144 + 5, 8 + 7));
            if (scene->getMonsters(66) && !ennemis[66]) ennemis[66] = (Ennemi*)(new Ennemi066(96 + 8, 80 + 10, 0));
            break;
        case 4 :
            if (scene->getMonsters(63) && !ennemis[63]) ennemis[63] = (Ennemi*)(new Ennemi063(16 + 7, 48 + 6));
            if (scene->getMonsters(71) && !ennemis[71]) ennemis[71] = (Ennemi*)(new Ennemi071(104 + 6, 48 + 8));
            if (scene->getMonsters(43) && !ennemis[43]) ennemis[43] = (Ennemi*)(new Ennemi043(184 + 8, 96 + 8));
            if (scene->getMonsters(19) && !ennemis[19]) ennemis[19] = (Ennemi*)(new Ennemi019(200 + 8, 32 + 8));
            if (scene->getMonsters(35) && !ennemis[35]) ennemis[35] = (Ennemi*)(new Ennemi035(248 + 8, 96 + 8));
            if (scene->getMonsters(24) && !ennemis[24]) ennemis[24] = (Ennemi*)(new Ennemi024(16 + 8, 144 + 8, false));
            if (scene->getMonsters(76) && !ennemis[76]) ennemis[76] = (Ennemi*)(new Ennemi076(80 + 6, 144 + 7));
            if (scene->getMonsters(31) && !ennemis[31]) ennemis[31] = (Ennemi*)(new Ennemi031(168 + 8, 160 + 8));
            if (scene->getMonsters(50) && !ennemis[50]) ennemis[50] = (Ennemi*)(new Ennemi050(232 + 8, 160 + 6));
            break;
        case 5 :
            if (scene->getMonsters(73) && !ennemis[73]) ennemis[73] = (Ennemi*)(new Ennemi073(24 + 8, 48 + 8, 0));
            if (scene->getMonsters(74) && !ennemis[74]) ennemis[74] = (Ennemi*)(new Ennemi074(176 + 8, 48 + 8));
            break;
    }
    ...
    switch (p) {
        case 0 :
            if (scene->getMonsters(4) || scene->getMonsters(53) || scene->getMonsters(54)
                 ...
                 || scene->getMonsters(5) || scene->getMonsters(30) || scene->getMonsters(15)
                 || scene->getMonsters(3) || scene->getMonsters(13) || scene->getMonsters(14)) {
                return false;
            }
            break;
        case 1 :
            if (scene->getMonsters(18) || scene->getMonsters(26) || scene->getMonsters(7)
                 || scene->getMonsters(2) || scene->getMonsters(25) || scene->getMonsters(21)
                 || scene->getMonsters(29) || scene->getMonsters(32) || scene->getMonsters(22)
                 || scene->getMonsters(16) || scene->getMonsters(23) || scene->getMonsters(42)
                 || scene->getMonsters(37) || scene->getMonsters(41) || scene->getMonsters(64)) {
                return false;
            }
            break;
        case 2 :
            if (scene->getMonsters(11) || scene->getMonsters(12) || scene->getMonsters(56)
                 || scene->getMonsters(33) || scene->getMonsters(34) || scene->getMonsters(38)
                 || scene->getMonsters(39) || scene->getMonsters(72) || scene->getMonsters(55)
                 || scene->getMonsters(44) || scene->getMonsters(46) || scene->getMonsters(47)
                 || scene->getMonsters(48)|| scene->getMonsters(75)) {
                return false;
            }
            break;
        case 3 :
            if (scene->getMonsters(57) || scene->getMonsters(60) || scene->getMonsters(62)
                 || scene->getMonsters(28) || scene->getMonsters(45) || scene->getMonsters(40)
                 || scene->getMonsters(66)) {
                return false;
            }
            break;
        case 4 :
            if (scene->getMonsters(63) || scene->getMonsters(71) || scene->getMonsters(43)
                 || scene->getMonsters(19) || scene->getMonsters(35) || scene->getMonsters(24)
                 || scene->getMonsters(76) || scene->getMonsters(31) || scene->getMonsters(50)) {
                return false;
            }
            break;
        case 5 :

...
void TextArea::handleActions(Action* action) {
    ...
    if (ready) {
        if (action->isAction(PUSH_UP)) {
            ...
            switch (id) {
                case 93 : case 284 :
                    newId = id + 2;
                    break;
                case 94 : case 95 : case 283 : case 285 : case 286 : case 288 : case 289 : case 290 : case 317 : case 319 : case 472 : case 473 :
                    newId = id - 1;
                    break;
                case 282 : case 316 : case 318 :
                    newId = id + 1;
                    break;
                case 287 :
                    newId = id + 3;
        ...
        if (action->isAction(PUSH_DOWN)) {
            int newId = -1;
            switch (id) {
                case 93 : case 94 : case 282 : case 284 : case 285 : case 287 : case 288 : case 289 : case 316 : case 318 : case 471 : case 472 :
                    newId = id + 1;
                    break;
                case 95 : case 286 :
                    newId = id - 2;
                    break;
                case 283 : case 317 : case 319 :
                    newId = id - 1;
                    break;
                case 290 :
                    newId = id - 3;
        ...
        if (action->isAction(PUSH_LEFT)) {
            int newId = -1;
            switch (id) {
                case 188 : case 224 : case 373 : case 435 : case 443 : case 452 : case 456 : case 459 : case 461 : case 464 : case 466 :
                case 474 : case 476 : case 502 : case 511 :
                    newId = id + 1;
                    break;
                case 189 : case 225 : case 374 : case 436 : case 444 : case 453 : case 457 : case 460 : case 462 : case 465 : case 467 :
                case 475 : case 477 : case 503 : case 512 :
                    newId = id - 1;
                    break;
                default : break;
            }
...
void TextArea::stop() {
    ...
    switch (id) {
        ...
        case 276 :
            ...
            break;
        case 281 : case 283 : case 286 : case 290 :
            link->setAnimation(IDLE);
            break;
        ...
        case 315 :
            ...
            break;
        case 318 :
            if (map->getId() == 15) MainController::getInstance()->getGameController()->getTeleportController()->setTeleport(1, 69 * 16 + 8, 37 * 16, S, false, true);
            else if (map->getId() == 16) MainController::getInstance()->getGameController()->getTeleportController()->setTeleport(3, 72 * 16 + 8, 15 * 16 + 8, S, false, true);
            else if (map->getId() == 17) MainController::getInstance()->getGameController()->getTeleportController()->setTeleport(4, 35 * 16 + 8, 20 * 16 + 8, S, false, true);
            else if (map->getId() == 18) MainController::getInstance()->getGameController()->getTeleportController()->setTeleport(8, 26 * 16 + 8, 40 * 16, S, false, true);
            else if (map->getId() == 19) MainController::getInstance()->getGameController()->getTeleportController()->setTeleport(14, 60 * 16, 34 * 16, S, false, true);
            else if (map->getId() == 20) MainController::getInstance()->getGameController()->getTeleportController()->setTeleport(11, 8 * 16, 51 * 16 + 8, S, false, true);
            else if (map->getId() == 21) MainController::getInstance()->getGameController()->getTeleportController()->setTeleport(6, 46 * 16 + 8, 30 * 16, S, false, true);
            else if (map->getId() == 22) MainController::getInstance()->getGameController()->getTeleportController()->setTeleport(9, 39 * 16 + 8, 27 * 16, S, false, true);
            else if (map->getId() == 23) MainController::getInstance()->getGameController()->getTeleportController()->setTeleport(5, 21 * 16 + 8, 19 * 16, S, false, true);
            else if (map->getId() == 24) MainController::getInstance()->getGameController()->getTeleportController()->setTeleport(14, 20 * 16 + 8, 18 * 16 + 8, S, false, true);
            else if (map->getId() == 25) MainController::getInstance()->getGameController()->getTeleportController()->setTeleport(8, 21 * 16, 8 * 16, S, false, true);
            else if (map->getId() == 26) {MainController::getInstance()->getGameController()->displayText(536); return;}
            else if (map->getId() == 27) MainController::getInstance()->getGameController()->getTeleportController()->setTeleport(45, 29 * 16 + 8, 8, S, false, true);
            else break;
            AudioManager::getInstance()->playSound(TS_TELEPORT);
            MainController::getInstance()->getGameController()->setStep(GAME_TELEPORT);
            return;
        case 322 :
            ...
            return;
        case 328 :
            if (scene->getMap()->getBounds()->getX() == 320*8) link->trouveObjet(TI_CLE, 5);
            else if (scene->getMap()->getBounds()->getY() == 240) link->trouveObjet(TI_CLE, 6);
            else link->trouveObjet(TI_CLE, 7);
            return;
        case 331 :
...
bool TextArea::hasLogicalNext() {
    ...
    int next = 0;
    switch (id) {
        case 89 : case 90 : case 102 : case 174 : case 320 : case 321 : case 329 : case 330 : case 343 : case 344 : case 351 :
        case 352 : case 353 : case 354 : case 355 : case 359 : case 361 : case 362 : case 374 : case 385 : case 386 : case 387 :
        case 388 : case 389 : case 391 : case 392 : case 393 : case 394 : case 395 : case 396 : case 397 : case 401 : case 402 :
        case 403 : case 404 : case 405 : case 406 : case 407 : case 408 : case 409 : case 416 : case 418 : case 419 : case 420 :
        case 421 : case 422 : case 426 : case 427 : case 428 : case 429 : case 430 : case 434 : case 437 : case 451 : case 470 :
        case 484 : case 485 : case 489 : case 490 : case 491 : case 492 : case 493 : case 496 : case 504 : case 507 : case 509 :
        case 513 : case 514 : case 516 : case 518 : case 524 : case 525 : case 526 : case 528 : case 529 : case 533 : case 534 :
            next = id + 1;
            break;
        case 96 :
        ...
        case 224 :
            ...
            break;
        case 189 : case 225 : case 444 : case 473 : case 475 : case 477 : case 503 : case 512 :
            next = 192;
            break;
        case 314 :
        ...
        case 323 :
            ...
            break;
        case 324 :
            if (scene->getMap()->getBounds()->getX() == 320*8) next = 325;
            else if (scene->getMap()->getBounds()->getY() == 240) next = 326;
            else next = 327;
            break;
